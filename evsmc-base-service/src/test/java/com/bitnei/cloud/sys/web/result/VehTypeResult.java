...
public class VehTypeResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, VehTypeModel vehTypeModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(vehTypeModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,VehTypeModel vehTypeModel) throws Exception {
