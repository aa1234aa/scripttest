package com.bitnei.cloud.lee.common.ueditor;

import java.io.*;
import java.util.HashMap;
import java.util.Map;

import com.bitnei.cloud.lee.common.ueditor.define.ActionMap;
...
public final class ConfigManager {
    ...
    private void initEnv() throws FileNotFoundException, IOException {
        ...
        if (os.startsWith("win")) {
            ...
            base = base.replace("/", java.io.File.separator);
        ...
        String linuxConfigPath = configPath.replace("\\", "/");

        String configContent = null;
        try {
            InputStream is = this.getClass().getClassLoader().getResourceAsStream("config.json");
            configContent = readFile(is);
//            configContent = this.readFile(configPath);
        } catch (Exception e) {
            configContent = this.readFile(linuxConfigPath);
        }
    ...
    private String readFile(String path) throws IOException {
        ...
        try {
            ...
            @Cleanup InputStreamReader reader = new InputStreamReader(new FileInputStream(path), "UTF-8");
            @Cleanup BufferedReader bfReader = new BufferedReader(reader);
