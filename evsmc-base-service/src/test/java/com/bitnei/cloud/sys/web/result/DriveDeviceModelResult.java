...
public class DriveDeviceModelResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, DriveDeviceModel driveDeviceModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(driveDeviceModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,DriveDeviceModel driveDeviceModel) throws Exception {
