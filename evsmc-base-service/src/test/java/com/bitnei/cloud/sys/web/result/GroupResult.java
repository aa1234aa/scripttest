...
public class GroupResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, GroupModel groupModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(groupModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,GroupModel groupModel) throws Exception {
