...
public class CodeRuleByteImportModel extends BaseModel {
    ...
    @ColumnHeader(title = "解析方式", example = "按字节解析", desc = "解析方式: 按字节解析，按bit位解析")
    ...
    @ApiModelProperty(value = "开始故障码连续帧数(单位:帧)")
