 ...
 * @since JDK1.8
 */
@Translate(dataSeqNos ={"2310"}, ruleEnums = {RuleTypeEnum.GB, RuleTypeEnum.DB})
public class DriverStatusTranslate implements ITranslate {
    /**
     * 解析
     *
    ...
    public Map<String, String> translate(String dataSeqNo, String value, RuleTypeEnum ruleTypeEnum) {
        ...
        if("1".equals(value)){
            resultMap.put(key, "耗电");
        }
        else if ("2".equals(value)){
            resultMap.put(key, "发电");
        }
        else if ("3".equals(value)){
            resultMap.put(key, "关闭");
        }
        else if ("4".equals(value)){
            resultMap.put(key, "准备");
        }
