...
@Slf4j
 public  class DataItemKey {
    ...
    public static final String RtDateTime = "10005";//实时数据更新时间
    ...
    public static final String[] getPowerOneMakerItemArray() {
    ...
    public static final String[] getPowerTwoMakerItemArray() {
