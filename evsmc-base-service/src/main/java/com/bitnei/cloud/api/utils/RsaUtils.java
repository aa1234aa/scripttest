...
import com.bitnei.cloud.api.model.RsaModel;
...
public class RsaUtils {
     ...
     */
    @SneakyThrows
    public static String decryptByPrivateKey(String dataStr, String key) {
    ...
    @SneakyThrows
    public static RsaModel getRsaKeyPair() {
        Map<String, Object> keyMap = init();
        String publicKey = getPublicKey(keyMap);
        String privateKey = getPrivateKey(keyMap);
        return new RsaModel(publicKey, privateKey);
    }
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        String decWord = decryptByPrivateKey(encWord, privateKey);
