...
public class FuelSystemModeResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url,FuelSystemModelModel fuelSystemModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(fuelSystemModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,FuelSystemModelModel fuelSystemModelModel) throws Exception {
