...
public class TermModelResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, TermModelModel termModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(termModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,TermModelModel termModelModel) throws Exception {
