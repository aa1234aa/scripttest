...
*/
@Slf4j
@Api(value = "字典类别", description = "字典类别",  tags = {"字典类别"})
@Controller
...
public class DictCategoryController{
    ...
    /** 模块基础请求前缀 **/
    public static final String BASE_AUTH_CODE ="DICTCATEGORY";
    /** 查看 **/
    ...
    @GetMapping(value = "/dictCategorys/{id}")
    @ResponseBody
    @RequiresPermissions(AUTH_DETAIL)
    public ResultMsg get(@PathVariable String id){

        DictCategoryModel dictCategory = dictCategoryService.get(id);
        return ResultMsg.getResult(dictCategory);
    }
    ...
    @GetMapping(value = "/dictCategorys/name/{name}")
    @ResponseBody
    @RequiresAuthentication
    public ResultMsg name(@PathVariable String name){

        DictCategoryModel dictCategory = dictCategoryService.getByName(name);
        return ResultMsg.getResult(dictCategory);
    ...
    @GetMapping(value = "/dictCategorys/code/{code}")
    @ResponseBody
    @RequiresAuthentication
    public ResultMsg code(@PathVariable String code){

        DictCategoryModel dictCategory = dictCategoryService.getByCode(code);
        return ResultMsg.getResult(dictCategory);
    ...
    @PostMapping(value = "/dictCategorys")
    @ResponseBody
    ...
    public ResultMsg list(@RequestBody @Validated PagerInfo pagerInfo, BindingResult bindingResult){
        ...
        Object result = dictCategoryService.list(pagerInfo);
    ...
    */
    ...
    public ResultMsg add(@RequestBody @Validated({GroupInsert.class}) DictCategoryModel demo1, BindingResult bindingResult){

        if (bindingResult.hasErrors()){
            return ResultMsg.getSchemaMsg(bindingResult);
        }
        dictCategoryService.insert(demo1);
    ...
    */
    ...
    @PutMapping(value = "/dictCategorys/{id}")
    @ResponseBody
    @RequiresPermissions(AUTH_UPDATE)
    public ResultMsg update(@RequestBody @Validated({GroupUpdate.class}) DictCategoryModel demo1, BindingResult bindingResult){

        if (bindingResult.hasErrors()){
            return ResultMsg.getSchemaMsg(bindingResult);
        }
        dictCategoryService.update(demo1);
    ...
    @DeleteMapping(value = "/dictCategorys/{id}")
    @ResponseBody
    @RequiresPermissions(AUTH_DELETE)
    @SLog(action = "删除")
    public ResultMsg delete(@PathVariable String id){

        int count = dictCategoryService.deleteMulti(id);
    ...
    @GetMapping(value = "/dictCategorys/export/{params}")
    ...
    public void export(@PathVariable String params) throws IOException {
        ...
        dictCategoryService.export(info);
        return ;
