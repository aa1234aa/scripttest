...
public class VehNoticeResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, VehNoticeModel vehNoticeModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(vehNoticeModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,VehNoticeModel vehNoticeModel) throws Exception {
