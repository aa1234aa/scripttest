...
public class PowerDeviceResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, PowerDeviceModel powerDeviceModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(powerDeviceModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,PowerDeviceModel powerDeviceModel) throws Exception {
