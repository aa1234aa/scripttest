...
public class VehSeriesResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, VehSeriesModel vehSeriesModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(vehSeriesModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,VehSeriesModel vehSeriesModel) throws Exception {
