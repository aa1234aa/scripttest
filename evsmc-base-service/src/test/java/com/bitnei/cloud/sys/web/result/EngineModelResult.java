...
public class EngineModelResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, EngineModelModel engineModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(engineModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,EngineModelModel engineModelModel) throws Exception {
