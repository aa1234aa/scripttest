...
* ----------------------------------------------------------------------------- <br>
* 工程名 ： 基础框架 <br>
* 功能： DayreportFuelItemAbnormalService接口<br>
* 描述： DayreportFuelItemAbnormalService接口，在xml中引用<br>
...
public interface IDayreportFuelItemAbnormalService extends IBaseService {
     ...
     */
     DayreportFuelItemAbnormalModel get(String id);
