...
public class UserResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, UserModel userModel) throws Exception {
    ...
    public ResultActions getUpdateResult(String url, String id, UserModel userModel) throws Exception {
