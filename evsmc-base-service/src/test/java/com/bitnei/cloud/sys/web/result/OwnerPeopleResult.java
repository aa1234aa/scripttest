...
public class OwnerPeopleResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, OwnerPeopleModel ownerPeopleModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(ownerPeopleModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,OwnerPeopleModel ownerPeopleModel) throws Exception {
