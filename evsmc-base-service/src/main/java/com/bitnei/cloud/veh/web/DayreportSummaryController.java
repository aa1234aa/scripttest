...
*/
@Slf4j
@Api(value = "总里程统计", description = "总里程统计",  tags = {"统计分析-运营分析-总里程统计"})
@Controller
@RequestMapping(value = "/"+ Version.VERSION_V1+"/veh")
public class DayreportSummaryController{
     ...
     * @return
     */
    @ApiOperation(value = "总里程统计多条件查询" , notes = "总里程统计多条件查询")
    @PostMapping(value = "/dayreportSummarys")
    @ResponseBody
    ...
    public ResultMsg list(@RequestBody @Validated PagerInfo pagerInfo, BindingResult bindingResult){
        ...
        Object result = dayreportSummaryService.list(pagerInfo);
     ...
     * @return
     */
    @ApiOperation(value = "总里程统计导出" ,notes = "总里程统计导出数据，传入参数应和分页查询保持一致")
    @GetMapping(value = "/dayreportSummarys/export/{params}")
    ...
    public void export(@PathVariable String params) throws IOException {
        ...
        dayreportSummaryService.export(info);
        return ;
    ...
    @GetMapping(value = "/dayreportSummarys/importSearchFile")
    @RequiresAuthentication
    public void getImportSearchFile(){
        dayreportSummaryService.getImportSearchFile();
        return;
    }
}
