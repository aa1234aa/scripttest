...
public class FuelGeneratorModelResult  extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, FuelGeneratorModelModel fuelGeneratorModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(fuelGeneratorModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,FuelGeneratorModelModel fuelGeneratorModelModel) throws Exception {
