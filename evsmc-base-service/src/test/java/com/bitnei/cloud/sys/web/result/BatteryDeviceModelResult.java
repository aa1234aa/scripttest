...
public class BatteryDeviceModelResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, BatteryDeviceModelModel batteryDeviceModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(batteryDeviceModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,BatteryDeviceModelModel batteryDeviceModelModel) throws Exception {
