...
public class SuperCapacitorModelResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, SuperCapacitorModelModel superCapacitorModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(superCapacitorModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,SuperCapacitorModelModel superCapacitorModelModel) throws Exception {
