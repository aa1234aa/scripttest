 ...
 * @since JDK1.8
 */
@Translate(dataSeqNos ={"1005", "2213"}, ruleEnums = {RuleTypeEnum.GB, RuleTypeEnum.DB})
public class RunModeTranslate  implements ITranslate{
    ...
    public Map<String, String> translate(String dataSeqNo, String value, RuleTypeEnum ruleTypeEnum) {
        ...
        if (value.equals("1")){
            resultMap.put(key, "纯电");
        }
        else if (value.equals("2")){
            resultMap.put(key, "混动");
        }
        else if (value.equals("3")){
            resultMap.put(key, "燃油");
        }
        return resultMap;
    }
}
