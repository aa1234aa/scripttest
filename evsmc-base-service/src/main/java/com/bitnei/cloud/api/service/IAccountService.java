...
* ----------------------------------------------------------------------------- <br>
* 工程名 ： 基础框架 <br>
* 功能： AccountService接口<br>
* 描述： AccountService接口，在xml中引用<br>
...
public interface IAccountService extends IBaseService {
     ...
     * @return
     */
    void insert(AccountModel model);
    ...
    */
    ...
    AccountModel findByToken(String token);

    AccountAuthorizationsDTO getAuthorizations(String applicationCode, String token);

    /**
     * 网关需要的一个不通过登录就赋予用户的令牌
     * @param userId
     * @return
     */
    TokenInfo grantUserToken(String userId);
