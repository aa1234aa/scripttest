...
public class DriveMotorModelResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, DriveMotorModelModel driveMotorModelModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(driveMotorModelModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,DriveMotorModelModel driveMotorModelModel) throws Exception {
