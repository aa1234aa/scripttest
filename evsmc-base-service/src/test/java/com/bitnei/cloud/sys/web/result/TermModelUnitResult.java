...
public class TermModelUnitResult extends BaseControllerTest {

    @Autowired
    private MockMvc mvc;

    public ResultActions getAddResult(String url, TermModelUnitModel termModelUnitModel) throws Exception {

        ResultActions   actions = mvc.perform(
                MockMvcRequestBuilders.post(url).headers(httpHeader())
                        .contentType(MediaType.APPLICATION_JSON).content(new ObjectMapper().writeValueAsString(termModelUnitModel)))
    ...
    public ResultActions getUpdateResult(String url, String id,TermModelUnitModel termModelUnitModel) throws Exception {
