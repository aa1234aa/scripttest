 ...
 * @since JDK1.8
 */
@Translate(dataSeqNos ={"2301"}, ruleEnums = {RuleTypeEnum.GB, RuleTypeEnum.DB})
public class ChargeStatusTranslate implements ITranslate{
    /**
     * 解析
     *
    ...
    public Map<String, String> translate(String dataSeqNo, String value, RuleTypeEnum ruleTypeEnum) {
        ...
        switch (value){
            case "1":
                resultMap.put(key, "停车充电");
                break;
            case "2":
                resultMap.put(key, "行驶充电");
                break;
            case "3":
                resultMap.put(key, "未充电状态");
                break;
            case "4":
                resultMap.put(key, "充电完成");
                break;
            case "254":
