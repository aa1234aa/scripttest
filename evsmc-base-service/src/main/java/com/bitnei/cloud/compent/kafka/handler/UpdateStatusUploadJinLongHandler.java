...
@Slf4j
public class UpdateStatusUploadJinLongHandler extends AbstractKafkaHandler {
    ...
    private static final String DOWNLOAD_SUCCESS = "2";
    private static final String DOWNLOAD_FAIL = "3";
    private static final String UPGRADE_SUCCESS = "4";
    private static final String UPGRADE_FAIL = "5";
    ...
    private void updateStatus(PlatformPojo platformPojo) {
        ...
        if (CollectionUtils.isNotEmpty(uppackageSendDetailsList)) {
            ...
            for (UppackageSendDetailsModel uppackageSendDetailsModel : uppackageSendDetailsModels) {
                ...
                Integer kafkaSEQ=Integer.valueOf(platformPojo.getData().get(SEQ));
                Integer sessionId=Integer.valueOf(uppackageSendDetailsModel.getSessionId());
                if (kafkaSEQ.intValue()!=sessionId.intValue()) {
